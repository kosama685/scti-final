...
var AddNetworkTraining = function AddNetworkTraining() {
  return __webpack_require__.e(/*! import() */ 55).then(__webpack_require__.bind(null, /*! ./AddNetworkingTraining.vue */ "./resources/js/views/admin/pages/NetworkTraining/AddNetworkingTraining.vue"));
};

var EditNetworkTraining = function EditNetworkTraining() {
  return __webpack_require__.e(/*! import() */ 56).then(__webpack_require__.bind(null, /*! ./EditNetworkTraining.vue */ "./resources/js/views/admin/pages/NetworkTraining/EditNetworkTraining.vue"));
};

var ViewNetworkTraining = function ViewNetworkTraining() {
  return __webpack_require__.e(/*! import() */ 58).then(__webpack_require__.bind(null, /*! ./ViewNetworkTraining.vue */ "./resources/js/views/admin/pages/NetworkTraining/ViewNetworkTraining.vue"));
};
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                              "tbody",
                              [
                                _vm._l(_vm.networktrainings.data, function(
                                  networktraining,
                                  index
                                ) {

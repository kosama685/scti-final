...
(function(window, document, $) {
    ...
    ***********************************************************/
    ...
    var ctx2 = document.getElementById("line-stacked-area-1").getContext("2d");
...
(function(window, document, $) {
    ...
    ***********************************************************/
    //Get the context of the Chart canvas element we want to select
    var ctx2 = document.getElementById("line-stacked-area-2").getContext("2d");
...
(function(window, document, $) {
    ...
    ***********************************************************/
    //Get the context of the Chart canvas element we want to select
    var ctx2 = document.getElementById("line-stacked-area-3").getContext("2d");

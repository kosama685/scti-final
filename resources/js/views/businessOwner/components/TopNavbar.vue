<template>
    ...
    <nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-light navbar-border">
        <div class="navbar-wrapper d-md-flex">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item mobile-menu d-md-none mr-auto"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="#"><i class="ft-menu font-large-1"></i></a></li>
                    <li class="nav-item">
                        <router-link class="navbar-brand" :to="{name:'public.dashboard'}"> <img class="brand-logo" alt="stack public logo" :src="`${base_url}/assets/images/logo.png`"> </router-link>
                    </li>
                    
                    <li class="nav-item d-md-none"> <a class="nav-link open-navbar-container" data-toggle="collapse" data-target="#navbar-mobile"><i class="fa fa-ellipsis-v"></i></a> </li>
                </ul>
            </div>
            <div class="navbar-container content w-100 d-flex">
                <div class="collapse navbar-collapse algn-self-center" id="navbar-mobile">
                    <ul class="nav navbar-nav mx-auto float-left">
                        <li class="nav-item">
                        <router-link class="" :to="{name:'businessOwner.dashboard'}">Dashboard</router-link>
                        </li>

                        <li class="nav-item">
                        <router-link class="" :to="{name:'businessOwner.jobs.create'}">Create Job</router-link>
                        </li>

                        <li class="nav-item">
                        <router-link class="" :to="{name:'businessOwner.jobs.index'}">My Jobs</router-link>
                        </li>

                        <li class="nav-item">
                        <router-link class="" :to="{name:'businessOwner.subscriptions.index'}">Subscribtion Log</router-link>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav float-right">
                        <bell-notification :viewAllLink="`businessOwner.notifications.index`"></bell-notification>
...
<!--                        </li>-->
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"> <span class="avatar avatar-online"> <img :src="editProfile.image" alt="avatar"> </span> <span class="user-name">{{name}}</span> </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <router-link class="dropdown-item" data-toggle="modal" :to="{name:'business.users.profile'}"><i class="fa fa-user-circle"></i>Profile</router-link>

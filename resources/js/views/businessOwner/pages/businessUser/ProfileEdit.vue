                                    ...
                                    <form ref="EditProfileForm" @submit.prevent="handleSubmit(EditProfile)">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <h1>
                                                        <router-link :to="{name: 'businessOwner.users.business.profile'}"><i
                                                    ...
                                                    <div class="col-12">
                                                        <div class="media align-items-center">
                                                            <div class="profile-img text-center edit-profille-img">
                                                                ...
                                                                <button type="button" name="file"><input type="file"
                                                    ...
                                                    <div class="card collapse-icon accordion-icon-rotate user_prof_acc">
                                                        ...
                                                        <div id="collapse12" role="tabpanel"
                                                         ...
                                                         <div id="headingCollapse12" class="card-header">
                                                            <a data-toggle="collapse" href="#collapse12"
                                                               aria-expanded="true" aria-controls="collapse12"
                                                               class="card-title lead ">Company Aim And Vision</a>
                                                        </div>
                                                        <div id="collapse12" role="tabpanel"
                                                             aria-labelledby="headingCollapse12" class="collapse show"
                                                             aria-expanded="true">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4 col-md-4 col-12 t-c">
                                                                            ...
                                                                            <input type="text" id="vision"
                                                                                   name="vision"
                                                                                   class="u-edit-txt"
                                                                                   v-model="editProfile.vision">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-md-1">
                                                                        <div class="col-lg-4 col-md-4 col-12 t-c">
                                                                            <p class="fieldName">No Of Employees</p>
                                                                            <input type="text" name="no_of_employees"
                                                                                   id="no_of_employees"
                                                                                   class="u-edit-txt"
                                                                                   v-model="editProfile.no_of_employees">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    methods: {
        ...
        async EditProfile(e) {
            ...
            if (response.data.data) {
                ...
                let self = this;
                setTimeout(function () {
                    self.$router.push({name: 'business.users.profile'});
                }, 1000);
            } else {

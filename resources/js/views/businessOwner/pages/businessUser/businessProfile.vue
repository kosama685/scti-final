...
<!--                                                                </div>-->
                                                                <div class="col-lg-4 col-md-4 col-12 t-c">
                                                                    ...
                                                                    <input type="text" name="cnum" class="u-edit-txt" :value="'+44'+editProfile.phone">
                                                                </div>
                                                ...
                                                <div id="headingCollapse19" class="card-header">
                                                    <a data-toggle="collapse" href="#collapse12" aria-expanded="true" aria-controls="collapse12" class="card-title lead ">Company Aim And Vision</a>
                                                </div>
                                                <div id="collapse12" role="tabpanel" aria-labelledby="headingCollapse19" class="collapse show" aria-expanded="true">
                                                    <div class="card-content">
                                                        <div class="card-body mt-sm-0 mt-2">
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-4 col-12 t-c">
                                                                    <p class="fieldName">Company Bio</p>
                                                                    <input type="text" name="bio" class="u-edit-txt" :value="editProfile.bio" disabled>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-12 t-c">
                                                                    <p class="fieldName">Aim And Vision</p>
                                                                    <input type="text" name="vision" class="u-edit-txt" :value="editProfile.vision" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-md-1">
                                                                <div class="col-lg-4 col-md-4 col-12 t-c">
                                                                    <p class="fieldName">No Of Employees</p>
                                                                <input type="text" name="no_of_employees" class="u-edit-txt" :value="editProfile.no_of_employees" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                        	<router-link :to="{name: 'business.users.editProfile'}" class="green-btn">Edit Profile</router-link>
	...
	export default{
		...
		methods: {
			async getProfile() {
				...
				console.log('edit profile is' ,this.editProfile.data.first_name);
			},
		}

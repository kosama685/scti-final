<template>
    <div class="content-wrapper">
        <div class="content-body">
                                    ...
                                    <div class="top mt-0 mt-md-5">
                                        <div class="row">
                                            <div class="col-12 text-md-right">
                                                <router-link :to="{name: 'admin.users.block'}" class="green-btn">Blocked Users
                                                    List
                                                </router-link>
                                            </div>
                                        </div>
                                                ...
                                                <td>
                                                    <div class="btn-group mr-1 mb-1">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start">
                                                            ...
                                                            <!-- <router-link class="dropdown-item"
                                                                         :to="{name: 'UserPaymentLog' ,params: {id: user.id}}">
                                                                <i class="fa fa-clipboard"></i>Pay log
                                                            </router-link> -->
                                                            <!--                                                    <router-link class="dropdown-item" :to="{name: 'EditUser',params: {id: user.id}}"><i class="fas fa-edit"></i>Edit</router-link>-->
                                                            <a class="dropdown-item" data-toggle="modal"
                                                               href="#blockPopup"
                                                               @click="BlockPopup(index)"><i class="fa fa-ban"></i>Block</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <block-popup-modal @delete="blockUser" :successButtonText="successButtonText" :primary-key="primaryKey"
                               table="block-user" :message="message"></block-popup-modal>
        </div>
    </div>
</template>
<script>
const BlockPopupModal = () => import('../../components/Block.vue');
export default {
    inject: ['formatDate'],
    data() {
        return {

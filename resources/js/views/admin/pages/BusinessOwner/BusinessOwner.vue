    ...
    <div class="content-wrapper">
        <div class="content-body">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h1>
                                                <router-link :to="{name:'public.dashboard'}"><i class="fa fa-angle-left"></i>User
                                                    Management
                                                </router-link>
                                            </h1>
                                        </div>
                                    ...
                                    <div class="top mt-0 mt-md-5">
                                        <div class="row">
                                            <div class="col-12 text-md-right">
                                                <router-link :to="{name: 'admin.users.business.block'}" class="green-btn">
            ...
            <block-popup @delete="blockUser" :successButtonText="successButtonText" :primary-key="primaryKey"
                         table="block-user" :message="message"></block-popup>
        </div>
    </div>
</template>
<script>

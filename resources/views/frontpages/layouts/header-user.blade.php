      ...
      <div class="col-md-5 my-auto">
        <div class="navwrp">
          <ul>
            ...
            <li>
              <a href="user/view-profile">Career Center</a>
            </li>
            <li>
              <a href="user/dashboard">Browse Jobs </a>
            </li>
            <li>
              <a href="user/contact-us">Contact</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <!--       <a href="{{ route('login') }}"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Logout</a> -->
            ...
            <li>
              ...
              <ul class="user-pro-drp pro-mnu-drop">
                <li>
                  <a href="user/view-profile"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a>
                </li>
                <li>
                  <a href="user/dashboard"><i class="fa fa-user" aria-hidden="true"></i> Browse Job</a>
                </li>
              </ul>
            </li>
          </ul>
